package com.yhd.bluetooth.app.activity;
...
import com.yhd.bluetooth.app.frag.Frag_bluetooth_client;
import com.yhd.bluetooth.app.frag.Frag_bluetooth_server;
import com.yhd.bluetooth.app.frag.Frag_bluetoothle;
import com.yhd.bluetooth.app.frag.Frag_main;

public class MainActivity extends RoActivity {

    private Class[] roFragments = {
            Frag_main.class,
            Frag_bluetooth_client.class,
            Frag_bluetooth_server.class,
            Frag_bluetoothle.class
    };
